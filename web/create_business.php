...
else
{
	...
	$result = mysqli_query($conn,"INSERT INTO tutor( email, field_1, field_2, field_3, field_4,	field_5, 		field_6, field_7, field_8,field_9,field_13,field_14,field_15,created_date	)
					VALUES(	'$get_email','$get_field_1', '$get_field_2', '$get_field_3', 
							'$get_field_4', '$get_field_5', '$get_field_6','$get_field_7',
							'$get_field_8','$get_field_9','$get_field_13',
							'$get_field_14','$get_field_15', '$get_created_date')");
