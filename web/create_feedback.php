...
{
	$result = mysqli_query($conn,"INSERT INTO feedback( email, field_1, field_2,created_date)
					VALUES(	'$get_email','$get_field_1', '$get_field_2','$get_created_date')");
					
	$result2 = mysqli_query($conn,"UPDATE tutor SET field_14= field_14 + '$get_field_1'
